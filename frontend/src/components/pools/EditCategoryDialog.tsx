...
import {
  ...
  TextField, Button, Stack, CircularProgress, Box, Typography, InputAdornment, Alert,
} from '@mui/material';
...
export default function EditCategoryDialog({ poolId, currency, category, open, onClose }: Props) {
  ...
  return (
    <Dialog open={open} onClose={() => !isLoading && onClose()} maxWidth="xs" fullWidth slotProps={{ paper: { sx: { bgcolor: 'background.paper' } } }}>
