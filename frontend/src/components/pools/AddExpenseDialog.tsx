...
import {
  ...
  TextField, Button, Stack, CircularProgress, MenuItem, Typography, InputAdornment,
} from '@mui/material';
...
export default function AddExpenseDialog({ poolId, currency, categories, open, onClose }: Props) {
  ...
  return (
    <Dialog open={open} onClose={reset} maxWidth="xs" fullWidth slotProps={{ paper: { sx: { bgcolor: 'background.paper' } } }}>
      <DialogTitle sx={{ fontWeight: 700, color: 'error.main' }}>Log Expense</DialogTitle>
      <DialogContent>
