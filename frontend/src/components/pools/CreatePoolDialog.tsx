...
export default function CreatePoolDialog({ open, onClose }: Props) {
  ...
  return (
    <Dialog open={open} onClose={resetAndClose} maxWidth="sm" fullWidth slotProps={{ paper: { sx: { bgcolor: 'background.paper' } } }}>
      <DialogTitle sx={{ fontWeight: 700 }}>Create New Pool</DialogTitle>
      <DialogContent>
